...
public class OrderlineController {
	...
	@PatchMapping(value = "/orderlines/{id}",  produces = {"application/json"}, consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Orderline> partialUpdateCustomer(
        ...
        return ResponseEntity
                .ok()
                .body(orderlineService.partialUpdate(orderline));
    }
